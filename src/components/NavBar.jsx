            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="hidden md:flex items-center gap-6">
                        ...
                        <Link to="/allreviews" className="text-gray-700 hover:text-green-700 transition">All Reviews</Link>
                ...
                {mobileMenuOpen && (
                    <div className="md:hidden bg-white border-t">
                        ...
                        <Link to="/allreviews" className="block px-4 py-3 text-gray-700 hover:bg-green-50">All Reviews</Link>
